...
class CRM_Nrm_Form_Report_VipApplication20 extends CRM_Report_Form {
  ...
  function preProcess() {
    $this->assign('reportTitle', ts('VIP Application Report for 2020'));
    parent::preProcess();
  }
  ...
  function where() {
    CRM_Nrm_BAO_Nrm::reportWhereClause($this->_where, 667);
  }
