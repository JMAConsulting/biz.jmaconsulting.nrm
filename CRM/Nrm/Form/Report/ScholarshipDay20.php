...
class CRM_Nrm_Form_Report_ScholarshipDay20 extends CRM_Report_Form {
  ...
  function preProcess() {
    $this->assign('reportTitle', ts('Chowan Scholarship Day Report for 2020'));
    parent::preProcess();
  }
  ...
  function where() {
    CRM_Nrm_BAO_Nrm::reportWhereClause($this->_where, 671);
  }
