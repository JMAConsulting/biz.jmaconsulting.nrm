...
class CRM_Nrm_Form_Report_PersonalVisit18 extends CRM_Report_Form {
  ...
  function preProcess() {
    $this->assign('reportTitle', ts('Personal Visit Day Report for 2018'));
    parent::preProcess();
  }
  ...
  function where() {
    CRM_Nrm_BAO_Nrm::reportWhereClause($this->_where, 429);
  }
