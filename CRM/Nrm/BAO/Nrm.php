...
class CRM_Nrm_BAO_Nrm extends CRM_Core_DAO {
  ...
  function updateWatchdog_nrm() {
    ...
    $sql = "INSERT INTO {$drupalDatabase}.watchdog_nrm (wid, location, timestamp, purl, purl_clean, hostname)
            ...
            SUBSTRING_INDEX(SUBSTRING_INDEX(w.location, '://', -1), '.upikebears2020.com', 1) as purl_clean,
            w.hostname
  ...
  function filterIP() {
    ...
    CRM_Core_DAO::executeQuery("DELETE FROM {$drupalDatabase}.watchdog_nrm WHERE purl = 'chowan2020.com.'");
    CRM_Core_DAO::executeQuery("DELETE FROM {$drupalDatabase}.watchdog_nrm WHERE purl = 'upikebears2020.com'");
    CRM_Core_DAO::executeQuery("DELETE FROM {$drupalDatabase}.watchdog_nrm WHERE purl = 'upikebears2020.com.'");
  }
}
